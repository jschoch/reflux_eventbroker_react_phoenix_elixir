defmodule RefluxEventbrokerReactPhoenixElixir.Endpoint do
  ...
  plug Plug.Static,
    at: "/", from: :reflux_eventbroker_react_phoenix_elixir, gzip: false,
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_reflux_eventbroker_react_phoenix_elixir_key",
    signing_salt: "4nIL/5CA"

  plug RefluxEventbrokerReactPhoenixElixir.Router
end
